...
const MovieDetails = () => {
    ...
    const { avatar, displayName } = useAuth(); // Puxa avatar e nome do usuário
        ...
        <div className={styles.detailsContainer}>
            <div className={styles.movieInfo}>
                ...
                <div className={styles.infoText}>
                    ...
                    <p><strong>Elenco:</strong> {/* Placeholder para elenco */}
                        {movie.credits?.cast?.slice(0, 5).map((actor) => actor.name).join(", ") || "Indisponível"}
                    </p>
                </div>
            </div>
